/*
 ...
 Source Catalog        : zeus-iot-专业版空库不要删
...
}', '{"url":"https://open.feishu.cn/open-apis/bot/v2/hook/c43e56f3-bdc9-4abb-ba4c-17afc6147f73","secret":"xoaP9dPKLeQIeDk5jZnEdg"}', NULL);
INSERT INTO "public"."media_type_setting" VALUES (2, 'dingtalk', '{
    "msgtype":"text",
    "text": {
        "content":"%s"
    }
}', '{"url":"https://oapi.dingtalk.com/robot/send?access_token=dd0f8a3340c15ec0f1d54b91980584c1127abe6dd143a964d44385647bc15124","secret":"SECb9675c586801a915b955888ebe88da7ae8bb55b9061e3e14d1424509a5dd5c60"}', NULL);
...
-- ----------------------------
INSERT INTO "public"."product_type" VALUES (244, 0, '默认产品分组', NULL, '[0],', 1442678404265623552, NULL, NULL, NULL, NULL);
...
INSERT INTO "public"."sys_dict" VALUES (1455808814382129152, 1455807294571880448, '22', '12', 'ENABLE', NULL, '22', '2021-11-03 16:07:23.625', '2021-11-03 16:08:10.475', 1, 1, NULL);
...
INSERT INTO "public"."sys_dict_type" VALUES (1455807294571880448, '456456', '456456', '', 'N', 'ENABLE', NULL, '2021-11-03 16:01:21.274', 1, '2021-11-03 16:01:21.274', 1);
...
-- Records of sys_role
-- ----------------------------
INSERT INTO "public"."sys_role" VALUES (1, '超级管理员', 'administrator', 1, NULL, NULL, NULL, NULL);
INSERT INTO "public"."sys_role" VALUES (2, '租户管理员', '', NULL, NULL, NULL, NULL, NULL);
INSERT INTO "public"."sys_role" VALUES (1443419927773007872, '租户用户', '租户里的普通用户。', NULL, 1, 1, '2021-09-30 11:38:22.882', '2021-09-30 11:50:37.275');
...
-- ----------------------------
INSERT INTO "public"."sys_role_menu" VALUES (1443419927773007872, 169);
INSERT INTO "public"."sys_role_menu" VALUES (1443419927773007872, 190);
INSERT INTO "public"."sys_role_menu" VALUES (1443419927773007872, 189);
INSERT INTO "public"."sys_role_menu" VALUES (1443419927773007872, 176);
INSERT INTO "public"."sys_role_menu" VALUES (1443419927773007872, 201);
INSERT INTO "public"."sys_role_menu" VALUES (1443419927773007872, 170);
INSERT INTO "public"."sys_role_menu" VALUES (1443419927773007872, 196);
INSERT INTO "public"."sys_role_menu" VALUES (1443419927773007872, 178);
INSERT INTO "public"."sys_role_menu" VALUES (1443419927773007872, 177);
INSERT INTO "public"."sys_role_menu" VALUES (1443419927773007872, 202);
INSERT INTO "public"."sys_role_menu" VALUES (1443419927773007872, 203);
INSERT INTO "public"."sys_role_menu" VALUES (1443419927773007872, 204);
INSERT INTO "public"."sys_role_menu" VALUES (1443419927773007872, 205);
INSERT INTO "public"."sys_role_menu" VALUES (1443419927773007872, 206);
INSERT INTO "public"."sys_role_menu" VALUES (1443419927773007872, 171);
INSERT INTO "public"."sys_role_menu" VALUES (1443419927773007872, 180);
INSERT INTO "public"."sys_role_menu" VALUES (1443419927773007872, 211);
INSERT INTO "public"."sys_role_menu" VALUES (1443419927773007872, 207);
INSERT INTO "public"."sys_role_menu" VALUES (1443419927773007872, 208);
INSERT INTO "public"."sys_role_menu" VALUES (1443419927773007872, 209);
INSERT INTO "public"."sys_role_menu" VALUES (1443419927773007872, 210);
INSERT INTO "public"."sys_role_menu" VALUES (1443419927773007872, 181);
INSERT INTO "public"."sys_role_menu" VALUES (1443419927773007872, 194);
INSERT INTO "public"."sys_role_menu" VALUES (1443419927773007872, 193);
INSERT INTO "public"."sys_role_menu" VALUES (1443419927773007872, 192);
INSERT INTO "public"."sys_role_menu" VALUES (1443419927773007872, 179);
INSERT INTO "public"."sys_role_menu" VALUES (1443419927773007872, 184);
INSERT INTO "public"."sys_role_menu" VALUES (1443419927773007872, 133);
INSERT INTO "public"."sys_role_menu" VALUES (1443419927773007872, 128);
...
INSERT INTO "public"."sys_role_menu" VALUES (2, 190);
INSERT INTO "public"."sys_role_menu" VALUES (2, 189);
INSERT INTO "public"."sys_role_menu" VALUES (2, 176);
INSERT INTO "public"."sys_role_menu" VALUES (2, 201);
...
-- Records of sys_user
-- ----------------------------
INSERT INTO "public"."sys_user" VALUES ('Admin', 'cbde417443393372dbac9c185a6ec159', 'gt3zs', '超级管理员', '', '', 1, 1437232484602372096, 'ENABLE', 1, 1, '2021-09-28 09:38:33.668', '2021-09-28 09:38:33.668', 1, '5613ff8a39fe5998d61873ccd450edae', '1', NULL, NULL);
...
-- ----------------------------
INSERT INTO "public"."sys_user_group" VALUES ('超级管理员组', '7', NULL, NULL, 1, '2021-10-11 11:40:12', 1, 'ENABLE', 1437232484602372096, NULL);
...
SELECT setval('"public"."device_online_report_id_seq"', 118, true);
...
SELECT setval('"public"."devices_groups_id_seq"', 582, true);
...
SELECT setval('"public"."media_type_setting_id_seq"', 76, true);
...
SELECT setval('"public"."messages_id_seq"', 6009, true);
...
SELECT setval('"public"."product_event_relation_id_seq"', 551, true);
...
SELECT setval('"public"."product_service_relation_id_seq"', 177, true);
...
SELECT setval('"public"."product_status_function_relation_id_seq"', 135, true);
...
SELECT setval('"public"."product_type_product_type_id_seq"', 348, true);
...
SELECT setval('"public"."scenes_trigger_record_id_seq"', 2, false);
...
SELECT setval('"public"."service_execute_record_id_seq"', 87, true);
...
SELECT setval('"public"."service_id_seq"', 78, true);
...
SELECT setval('"public"."service_param_id_seq"', 50, true);
...
SELECT setval('"public"."sys_user_user_id_seq"', 190, true);
...
SELECT setval('"public"."tag_id_seq"', 329, true);
...
SELECT setval('"public"."task_info_id_seq"', 7, true);
